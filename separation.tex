...
With respect to variation in underlying physical parameters, such a spectroscopic or diffraction dataset can be assembled into a tensor of the form 
...
\begin{figure}
  \includegraphics[width=\linewidth]{paper_figures/4/Tfeatures.png}
...
\begin{figure}
  \includegraphics[width=\linewidth]{paper_figures/5/T_peakfit.png}
%  \caption{(a) Color-coded features identified from peaks connected in
%$i,q$ space for XRD dataset $X_{iq}$ corresponding to a temperature scan
%of XRD patterns for xxxxxx system. Index $i$ denotes temperature.
%    
